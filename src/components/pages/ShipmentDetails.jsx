          ...
          <div>
            <div key={shipmentDetail?.data.id} className="bg-primary rounded-t-xl mt-5 text-white flex justify-between p-5 min-w-max">
              <div className="flex gap-3 font-semibold">
                <img className="bg-white rounded-full h-8 w-auto" src={Export} alt="" />
                <span className="first-letter:uppercase">{shipmentDetail?.data?.shipping_type}</span>
              </div>
              <p>{formatDate(shipmentDetail?.data?.shipment_pickup_date)}</p>
              <div>
                <p>Shipment ID</p>
            ...
            >
              <div className="max-w-md flex justify-between items-center">
                <div className="font-semibold">
                  ...
                  <h1 className="text-2xl">{shipmentDetail?.data?.local_government}</h1>
                ...
                <div className="font-semibold">
                  ...
                  <h1 className="text-2xl">{shipmentDetail?.data?.destination_port_city}</h1>
            ...
            <Tabs className="mt-5 w-full">
              <div className="w-full border-b-2 py-2">
                <TabList className="flex max-w-md justify-between">
                  ...
                  <Tab className="outline-none ml-6">Cargo Details</Tab>
                  <Tab className="outline-none ml-6">Additional Services</Tab>
                  <Tab className="outline-none ml-6">Rates</Tab>
                </TabList>
              </div>
